...
import 'code_search_model.dart';
export 'code_search_model.dart';

class CodeSearchWidget extends StatefulWidget {
  const CodeSearchWidget({Key? key}) : super(key: key);

  @override
  _CodeSearchWidgetState createState() => _CodeSearchWidgetState();
}

class _CodeSearchWidgetState extends State<CodeSearchWidget> {
  late CodeSearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CodeSearchModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('notRecognizable');
                        },
                        child: Container(
                          width: double.infinity,
                          height: 40.0,
                          ...
                          StreamBuilder<List<MissingPeopleRecord>>(
                            stream: queryMissingPeopleRecord(
                              queryBuilder: (missingPeopleRecord) =>
                                  missingPeopleRecord.where('personId',
                                      isEqualTo:
